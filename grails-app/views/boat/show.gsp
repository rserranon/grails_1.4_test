	...
	<body>
		...
		<div id="show-boat" class="content scaffold-show" role="main">
			...
			<ol class="property-list boat">
				...
				<g:if test="${boatInstance?.owner}">
				<li class="fieldcontain">
					<span id="owner-label" class="property-label"><g:message code="boat.owner.label" default="Owner" /></span>
					
						<span class="property-value" aria-labelledby="owner-label"><g:fieldValue bean="${boatInstance}" field="owner"/></span>
